...
public class MinHeap2Test {
    ...
    public void testHeapInt() {
        MinHeap2<Integer> heap = new MinHeap2<Integer>(5);
    ...
    public void testHeapPerson() {
        ...
        MinHeap2<Person> heap = new MinHeap2<Person>(5);
        heap.insert(p1);
        heap.insert(p2);
    ...
    public void testHeapTArray() {
        MinHeap2<Integer> heap = new MinHeap2<Integer>(arr);
    ...
    public void testIsFull() {
        MinHeap2<Integer> heap = new MinHeap2<Integer>(2);
    ...
    public void testInsertTen() {
        MinHeap2<Integer> heap = new MinHeap2<Integer>(arr.length);
        for (Integer i : arr) {
            heap.insert(i);
        }
        assertEquals("[1,2,5,4,3,9,6,10,7,8]", heap.toString());
